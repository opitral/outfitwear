...
<body class="w-full flex col">
  ...
  <main class="wrapper flex col grow" id="main_content">
    <h2 class="fs-24 medium">Товари</h2> 
    <div class="flex flex-center md:grow admin">
      <form action="" class="w-full md:w-640 m-md:mt-20">
        ...
        <input required  type="tel"  name="phone" placeholder="Категорія">
        <input required  type="text" name="city"  placeholder="Ціна">
        <input required  type="text" name="post"  placeholder="Фото">
        <button class="btn btn_fill w-full" type="submit">Додати товар</button>
      </form> 
    </div>
  </main>
