...
<body class="w-full flex col">
  ...
  <main class="wrapper flex col grow" id="main_content">
    <h2 class="fs-24 medium">Вхід</h2> 
    <div class="flex flex-center md:grow admin">
      <form action="" class="w-full md:w-640 m-md:mt-20">
        <input required  type="text" name="name"  placeholder="Логін">
        <input required  type="text" name="city"  placeholder="Пароль">
        <button class="btn btn_fill w-full" type="submit">Увійти</button>
        <div class="w-full h-50 mt-20 bg-$red flex flex-center r-5 c-f">Невірний логін або пароль</div>
      </form> 
    </div>
  </main>
